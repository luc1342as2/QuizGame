/** 
 * Lucas Ghigli
 * GameScreenFXMLController.java -> Quiz FX
 * 08/08/2022
 */
...
public class GameScreenFXMLController implements Initializable {
    ...
    String[] questions_Easy = { //easy mode questions.
...
String[] questions_Hard = { //hard questions.
...
char[] answers_Easy =   {  //answers to the easy mode questions.
    'A',
    'C',
    'B',
    'A',
...
char[] answers_Hard =    { //answers to the hard mode questions.
       'A',
       'A',
       'D',
       'C',
    ...
    int CGusses = 0;
    int count;
    int TQuestions_Easy = questions_Easy.length; //size of the easy questions.
    int TQuestions_Hard = questions_Hard.length; //size of the hard questions.
    int qn;
    ...
    private void optionA_Btn(ActionEvent event) throws InterruptedException, IOException {
        ...
        answer = 'A';
        if(StartmenuFXMLController.level=="Easy"){ //easy mode.
        ...
        else if(StartmenuFXMLController.level=="Hard"){ //hard mode.
    ...
    private void optionC_Btn(ActionEvent event) throws InterruptedException, IOException {
        ...
        if(answer==answers_Easy[index])
         ...
         if(answer==answers_Hard[index])
            ...
            System.out.println("restart quiz "); //it prints the following mode.
...
/**Information about the easy mode **/
        ...
        { if(StartmenuFXMLController.level=="Easy"){ //Easy mode quiz.
            ...
            current_score_Lbl.setText("Current Points: "+CGusses+"/100"); //it keeps track of the player's points.
            progress_Lbl.setText("Progress: "+(qn+1)+"/20"); //it keeps track of the progress.
            n++;
        
        
        }
/**Information about the hard mode. **/
        else if(StartmenuFXMLController.level=="Hard"){ //Hard mode quiz.
           questionlbl.setText("Question "+(qn+1));
    ...
    public void results() throws IOException
    {
        ...
        stage2.setTitle("Lose Screen"); //it prints this title if you fail the quiz.
        ...
        stage2.setScene(new Scene(root));//it creates a new scene in stage2.
        stage2.show(); //it shows the stage2.
        stage2.setTitle("Win Screen"); //it prints this title if you pass the quiz.
     ...
     FXMLLoader loader=new FXMLLoader(getClass().getResource("promptScreenFXML.fxml"));
        ...
        stage2.setScene(new Scene(root));//it creates a new scene in stage2.
        stage2.show(); //it shows the stage2.
        stage2.setTitle("Game"); //it prints this title in the stage2.
     }
     
     }

/** Information about the answers for each level **/    
